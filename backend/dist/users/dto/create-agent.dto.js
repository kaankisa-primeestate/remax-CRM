...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(user_entity_1.CompanyType, { message: 'Geçerli bir şirket türü seçin' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(user_entity_1.CommissionShareType, { message: 'Geçerli bir komisyon paylaşım tipi seçin' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)({}, { message: 'Geçerli bir sözleşme başlangıç tarihi girin' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)({}, { message: 'Geçerli bir sertifika tarihi girin' }),
    __metadata("design:type", String)
