...
let PortfoliosController = class PortfoliosController {
    ...
    findAll(user, search, propertyType, listingType, status, district, minPrice, maxPrice, minArea, maxArea, agentId) {
        return this.portfoliosService.findAll({ search, propertyType, listingType, status, district, minPrice, maxPrice, minArea, maxArea, agentId }, user);
    }
    findOne(id, user) {
