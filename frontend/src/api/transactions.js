...
export const transactionsApi = {
  ...
  addNote: (id, text, isBrokerFlag) => apiClient.post(`/transactions/${id}/notes`, { text, isBrokerFlag }).then((r) => r.data),
  resolveNoteFlag: (noteId) => apiClient.patch(`/transactions/notes/${noteId}/resolve`).then((r) => r.data),
  getUnresolvedBrokerFlags: () => apiClient.get('/transactions/broker-flags/unresolved').then((r) => r.data),
