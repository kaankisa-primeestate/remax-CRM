...
export default function PublicPropertyPage() {
  ...
  if (error) {
    return (
      <div style={{ maxWidth: 480, margin: '80px auto', textAlign: 'center', fontFamily: 'var(--font-body)', color: 'var(--cl-muted)' }}>
        {error}
      </div>
    );
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--cl-bg)' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '32px 16px 48px' }}>
        <div style={{ background: 'var(--cl-surface)', border: '1px solid var(--cl-border)', borderRadius: 16, padding: '28px 28px 32px', boxShadow: '0 4px 20px rgba(16, 35, 61, 0.06)' }}>
          <h1 style={{ fontFamily: 'var(--cl-font-heading)', fontWeight: 800, fontSize: 26, marginBottom: 4, color: 'var(--cl-text)' }}>{property.title}</h1>
          <div style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--cl-muted)', marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 20 }}>
              {property.photoUrls.map((url, i) => (
                <img
                  ...
                  style={{ width: '100%', maxWidth: 340, height: 240, objectFit: 'cover', borderRadius: 10, border: '1px solid var(--cl-border)', cursor: 'pointer' }}
          ...
          {extras.length > 0 && (
            <div style={{ marginBottom: 24, fontSize: 14, color: 'var(--cl-text)' }}>
